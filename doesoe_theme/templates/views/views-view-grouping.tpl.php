 ...
 *
 * How this differs from the default template:
 * - Classes_array used for wrapper class
 * - Attributes_array added to the wrapper.
 */
?>
<div class="<?php print implode(' ', $classes_array); ?>" <?php print drupal_attributes($attributes_array); ?>>
